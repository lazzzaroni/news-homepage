...
function MenuOpen(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="40"
      height="17"
...
function MenuClose(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="32"
      height="31"
...
export { Logo, MenuOpen, MenuClose };
